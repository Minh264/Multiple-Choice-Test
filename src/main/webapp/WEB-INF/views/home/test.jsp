 ...
 <div class="page-section">
			<div class="container">
				<div class="row justify-content-center">
						...
						<div class="card-page">
							<div class="row row-beam-md " style="margin-left: 0px">
								<div class="col-md-4 text-center py-3 py-md-2">
									<p class="fg-primary fw-medium fs-vlarge">Test Management</p>
									<p class="mb-0">Select insert or update to edit test </p>
								</div>
								<select id="btn" class="btn btn-primary"  type="submit" style="margin-top: 40px;margin-bottom: 40px" onchange="onChanged(this)">
					...
					<!-- Load -->
					<div id="fload" style="display: none" >
...
$(document).ready(function() {
	...
	function onChanged(obj){
		...
		if(value =="insert"){
			...
			$('#fload').load('test-management/test-insert');  			    					    	
		}else if(value =="update"){
			form.setAttribute("style","display:inline");
			$('#fload').load('test-management/test-update')
		}else {
