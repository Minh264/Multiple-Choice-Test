...
<div class="page-hero-section bg-image hero-mini" style="background-image: url(../assets/img/hero_mini.svg);">
 ...
 <div class="page-section">
    <div class="container">
      ...
      <div class="card-page"> <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Test Name..." title="Type in a name">
      </div>    
      <br>
	...
	$.ajax({
		...
		success : function(data) {			
	        ...
	        $.each(data, function (i, item) {	        	
	        		 trHTML += '<tr><td>' + item.id + '</td><td>'+ item.creationDateTime + '</td><td>' + item.time + '</td><td>'+ item.submitDateTime + '</td><td>'+ item.result + '</td><td>'+ item.name + '</td><td>'+ item.username + '</td><td><button id="btndelete" class="btn btn-primary" >Delete</button></td></tr>';	      	        	          
	        });
