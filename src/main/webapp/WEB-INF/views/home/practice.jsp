...
<div class="page-hero-section bg-image hero-mini" style="background-image: url(http://localhost:8080/MultiChoose_02/assets/img/hero_mini.svg);">
 ...
 <div class="page-section">
    ...
    <ul class="form-section page-section" id="list">
		...
		success : function(data) {			
	        ...
	        $.each(data.listQuestion, function (i, item) {	        	
	        	...
	        	if(item.type.id == 11){
	        	    ...
	        	    trHTML +='<button id="'+item.id+'" type="submit" class="form-submit-button description-button jf-form-buttons jsTest-submitField" data-component="button">Description</button></li>';	
	        	    ldsAnswer.push(item.id);
	        	    var strdes = {
	        				id : item.id,
						type : item.type.id,
