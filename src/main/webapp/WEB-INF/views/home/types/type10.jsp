...
<body>
	...
	<div class="form-group" id="fmain">
		<h3 class="fw-normal">Insert True or False Question</h3>	
			...
			<div class="form-group">
                <label for="name" class="fw-medium fg-grey">Answer</label>
                <input type="text" class="form-control" id="btnanswer" placeholder="Enter Answer ">
              </div>
			<div class="form-group">
	...
	$(document).ready(function() {
		...
		var $answerd =$('#answerd');	
			$('#btnsend').on('click',function(){
				var check =0;
				if($content.val()=="" || $description.val()=="" || $level.val()=='base' || $answer.val()=="" || $descriptionAnswer.val()=="" || $contentAnswer.val()=="" || $answera.val()=="" || $answerb.val()=="" || $answerc.val()=="" || $answerd.val()==""){
				...
				if($content.val()!="" && $description.val()!="" && $level.val()!='base' && $answer.val()!="" && $descriptionAnswer.val()!="" && $contentAnswer.val()!="" && $answera.val()!="" && $answerb.val()!="" && $answerc.val()!="" && $answerd.val()!="" && check==0){
					var details =[{
						answer : $answer.val(),
					...
					$.ajax({
					type : 'POST',
					url : 'https://testing-api-1.herokuapp.com/api/question/type10',
